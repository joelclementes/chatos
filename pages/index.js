                ...
                <div className="card card-body bg-secondary text-light rounded">
                    <div className="row">
                        ...
                        <div className="col-md-9">
                            ...
                            <p>
                                Somos una empresa familiar que inició su servicio en 2020 en la
                                ciudad de Xalapa, Ver. Y surge con la visión de ofrecer a sus
                                clientes una experiencia que permita compartir valiosos momentos
                                en familia.
                            </p>
                        </div>
                    </div>
